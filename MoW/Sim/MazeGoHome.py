"""
D* Lite maze navigation - goes to end, returns home, then optimal path
"""
...
# ============ PHASE 3: Optimal Path to End ============
print("\n=== PHASE 3: Optimal Path to End ===")
title.set_text('D* Lite Maze Navigation - Phase 3: Optimal Path')
...
while (current_x, current_y) != (end_x, end_y):
    obstacles = api.Plane_getBarrier()
    update_plot(obstacles, current_x, current_y)
...
print(f"Phase 3 (Optimal path):   {optimal_steps} steps")
print(f"=============================")
